...
public class addAuthor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String creationdate=request.getParameter("acdate");
        String updationdate=request.getParameter("audate");
        ...
        java.util.Date thisDate=new java.util.Date();
         ...
         Statement st1=con.createStatement();
          ResultSet res5=st1.executeQuery("select max(aid) from Author");
            int Id=0;
            while(res5.next()){
            Id=res5.getInt(1);
            }
            ...
            String query1="insert into Author values('"+aid+"','"+aname+"','"+creationdate+"','"+updationdate+"','"+cstatus+"');";
...
"             <center><h1 style=\"color:green; \"><b><h1>"+aname+" with ID: "+aid+" is Successfully Added</h1></center>\n" +
"        </div>");
            }
            else{
                out.println(""
                        + "<div id='msg' style='box-shadow: 0 0 7px red;border: 2px solid red ;'>\n" +
"             <center><h1 style=\"color:red; \"><b><h1>Not Added ..!</h1></b></h1></center>\n" +
"        </div> ");
            }
           /* if(status==1){
                out.println("<h1>"+aname+" with ID :"+aid+" is successfully added</h1>");
            }
            else{
                out.println("<h1>"+aname+" with ID :"+aid+" already exist</h1>");
            }*/
            out.println(aid+" "+aname+" "+creationdate+" "+updationdate+" "+cstatus);
