...
public class viewAuthor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
         ...
         String query2="select count(*) from Author;";
...
"            }");
            ...
            Session.setAttribute("ac",""+c);
            out.println("<center><h1 style='color:red;'>Total Books ("+" "+c+" )</h1></center>");
            out.println("<center><table border=3px>");
            out.println("<tr><th>AUTHOR-ID</th><th>AUTHOR</th><th>CREATION-DATE</th><th>UPDATION DATE</th></tr>");
            while(result.next()){
                out.println("<tr>");
                out.println("<td>"+result.getString("aid")+"</td>"+"<td>"+result.getString("aname")+"</td>"+"<td>"+result.getString("creationdate")+"</td>"+"<td>"+result.getString("updationdate")+"</td>");
                out.println("</tr>");
            }
