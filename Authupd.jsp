...
<html>
    ...
    <body>
        ...
        out.println("aid");
        %>
         <form action="Auth_Upd" method="post">
             <center><h1 style="color:#063d63; "><b>AUTHOR</b></h1></center>
             <div style="color:red;"><center><p>Enter the data if you want to modify ...!</p><center></div>   
                                <div class="form-floating mb-4 mt-4">
                                        <input class="form-control" type="text" id="fauth" name="aname" placeholder="Category Name" Style="height:69px;background: transparent;border: none; border-bottom: 2px solid black;">
                                        <label for="fauth"> Author Name</label>
                                </div>
                                <div class="form-floating mb-4 mt-4" style='display:none;'>
                                        <input class="form-control" type="text" id="fauth" name="aid" value='<%out.println(cid);%>' placeholder="Category Name" Style="height:69px;background: transparent;border: none; border-bottom: 2px solid black;">
