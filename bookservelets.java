 ...
 * @author maruthi
 */
public class bookservelets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String bookid=request.getParameter("ibid");
        String idate="";
        String days="";
        String rdate="";
        int dur=0;
        Class.forName("com.mysql.cj.jdbc.Driver");                
            ...
            String query10="select * from cbooks where id='"+bookid+"'";
            ResultSet res10=st3.executeQuery(query10);
            while(res10.next()){
                name=res10.getString("title");
                author=res10.getString("author");
                category=res10.getString("genre");
                
            }
            int q=0;
            //String query="insert into Issue values('"+bookid+"','"+name+"','"+author+"','"+category+"','"+sid+"','"+idate+"','"+days+"','"+rdate+"')";
            //int xy=0;
            //xy=st.executeUpdate(query);
       ...
       rdate=dateForm.format(current);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            /*if(xy==1){
                ...
                out.println("failed inserted");
            }*/
            out.println(name+" "+author+" "+category);
