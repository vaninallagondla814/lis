 ...
 * @author maruthi
 */
public class Cat_Upd extends HttpServlet {
...
"             <center><h1 style=\"color:green; \"><b><h1> Category with ID: "+ cid+" Successfully Updated </h1></center>\n" +
"        </div>");
            }
            else{
                out.println(""
                        + "<div id='msg' style='box-shadow: 0 0 7px red;border: 2px solid red ;'>\n" +
"             <center><h1 style=\"color:red; \"><b><h1>Category with ID: "+cid+" Not Updated !!!!</h1></h1></center>\n" +
"        </div> ");
            }
            /*out.println(cid+" "+cname+" "+cstatus+" "+creationdate+" "+updationdate);
            if(status==1){
                out.println("<h1>category with ID :"+cid+" is successfully Updated</h1>");
            }
            if(status==0){
                out.println("<h1>category with ID :"+cid+" is not Updated</h1>");
            }*/
